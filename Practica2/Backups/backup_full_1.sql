...
CREATE TABLE `characters` (
  ...
  `mug_shot` varchar(255) DEFAULT NULL,
...
LOCK TABLES `multiplayer_modes` WRITE;
/*!40000 ALTER TABLE `multiplayer_modes` DISABLE KEYS */;
/*!40000 ALTER TABLE `multiplayer_modes` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-02-23 22:46:14
